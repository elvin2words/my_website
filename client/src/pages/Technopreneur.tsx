...
import { ArrowLeft, Lightbulb, TrendingUp, Users, BarChart } from 'lucide-react';
      ...
      <div className="relative z-10">
        <main className="pt-24 pb-16 px-4 md:px-0 flex flex-col items-center min-h-screen">
          <div className="container mx-auto max-w-7xl">
            <div className="mb-8">
              <Link href="/">
                <Button variant="ghost" className="flex items-center text-accent4 hover:text-accent4">
            ...
            <div className="mb-10">
              <h1 className="text-4xl md:text-5xl font-poppins font-bold mb-4 text-accent4">
