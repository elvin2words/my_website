          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
              ...
              <Card className="bg-card/60 backdrop-blur border-card-border hover-elevate">
                <CardHeader>
                  <CardTitle className="font-mono text-xs text-slate-700">developer.js</CardTitle>
                </CardHeader>
                <CardContent>
          ...
          <div className="max-w-7xl mx-auto">
                  ...
                  >
                    ...
                    <CardHeader className="flex-grow">
                      <div className="space-y-2">
                        ...
                        <CardDescription className="line-clamp-2 text-sm text-slate-300 leading-relaxed">
                          {project.description}
                        </CardDescription>
                      </div>
                    </CardHeader>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {project.technologies.slice(0, 4).map((tech) => (
                            <Badge 
                              key={tech} 
                              variant="secondary" 
                              className="text-xs px-2 py-0.5 bg-primary/10 text-gray-400 hover:bg-primary/20 transition-colors"
                            >
                              {tech}
                            </Badge>
                          ))}
                      ...
                      <div className="pt-2 border-t border-border/50 grid grid-cols-2 gap-2 text-xs">
                        <div className="space-y-1">
                          <p className="text-slate-500">Stack Size</p>
                          <p className="font-semibold text-slate-300">{project.technologies.length} techs</p>
                        </div>
                        <div className="space-y-1">
                          <p className="text-slate-500">Features</p>
                          <p className="font-semibold text-slate-300">{project.features?.length || 0}+</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
            ...
            <div className="text-center mt-16">
              <Button 
                ...
                className="gap-2 hover-elevate hover:text-lg hover:bg-slate-700 bg-slate-900"
                asChild
              >
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
                  {skills.frontend.map((skill, index) => {
                    ...
                    return (
                      <div
                        key={skill.name}
                        className="group relative h-40 rounded-lg overflow-hidden border border-cyan-900 border-border hover-elevate cursor-default transition-all duration-300"
                      ...
                      >
                        ...
                        <div className="relative h-full flex flex-col items-center justify-center p-6 text-center">
                          <div className="mb-3 p-3 rounded-lg bg-accent2/10 group-hover:bg-primary/20 transition-colors duration-100">
                            <Icon className="h-8 w-8 text-slate-200 group-hover:scale-110 group-hover:text-white transition-transform duration-100" />
                          </div>
                          <span className="font-semibold text-slate-400 group-hover:text-white transition-colors duration-300">{skill.name}</span>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {skills.backend.map((skill, index) => {
                    ...
                    return (
                      <div
                        key={skill.name}
                        className="group relative h-40 rounded-lg border-gray-500 overflow-hidden border border-border hover-elevate cursor-default transition-all duration-300"
                        style={{ animationDelay: `${index * 50}ms` }}
                        data-testid={`skill-card-${skill.name}`}
                      >
                        <div className={`absolute inset-0 bg-gradient-to-br ${skill.color} opacity-0 group-hover:opacity-10 transition-opacity duration-500`} />
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
                  {skills.tools.map((skill, index) => {
                    ...
                    return (
                      <div
                        key={skill.name}
                        className="group relative border-cyan-900 h-40 rounded-lg overflow-hidden border border-border hover-elevate cursor-default transition-all duration-300"
                        style={{ animationDelay: `${index * 50}ms` }}
                        data-testid={`skill-card-${skill.name}`}
                      >
                        <div className={`absolute inset-0 bg-gradient-to-br ${skill.color} opacity-0 group-hover:opacity-10 transition-opacity duration-500`} />
