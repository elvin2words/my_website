...
//     >
//       <div
//         className="absolute top-0 right-0 w-1/3 h-1/3 bg-accent1 rounded-full filter blur-[150px] animate-pulse-slow"
//         style={{
...
//       />
//       <div
//         className="absolute bottom-0 left-0 w-1/3 h-1/3 bg-accent2 rounded-full filter blur-[150px] animate-pulse-slow"
//         style={{
//           willChange: 'transform, opacity',
//           transform: 'translateZ(0)',
//           contain: 'paint'
...
//       />
//       <div
//         className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1/3 h-1/3 bg-accent4 rounded-full filter blur-[150px] animate-pulse-slow"
//         style={{
//           willChange: 'transform, opacity',
//           transform: 'translateZ(0)',
//           contain: 'paint'
